...
locals {
  has_network = try(signum(data.ns_connection.network.outputs.private_subnet_ids), 0) > 0
  ...
  has_subdomain      = try(signum(data.ns_connection.subdomain.outputs.fqdn), 0) > 0
